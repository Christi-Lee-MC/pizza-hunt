...
// this request acts as an event listener for the DB
const request = indexedDB.open('pizza_hunt', 1);

// add another event listener after const request
...
// if we attempt to submit a new pizza
