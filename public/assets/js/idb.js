...
request.onsuccess = function(event) {
    ...
    // (from onupgradedneeded event above) or 
    // simply established a connection, 
    ...
    //   but we will soon, so let's comment it out for now
      // uploadPizza();
    }
  };

  // This function will be executed 
//   f we attempt to submit a new pizza and 
